...
if __name__ == "__main__":
    ...
    consumer_parse.add_argument("--subscribe", "-s", help="Comma separeted list of topics to subscribe")
    consumer_parse.add_argument("--batch", "-b", help="Switch to batch consumer", action="store_true")
    ...
    producer_parse.add_argument("--dataclass",  "-d",  help="Dataclass from app.messages custom serialization", default=None)
